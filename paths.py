...
# # for local MAC, work from home - from Han
...
# Francesca paths
_data_path = Path('/Users/francescalim/OneDrive - cumc.columbia.edu/stroke_model')
# Door-to-needle times (sensitive data - hospitals de-identified)
...
# Path to patient profiles
PATIENT_PATH = _data_path/'data/patient_profiles_01_30_20.csv'

# first_quartile, median, third_quartile, sample_size
